    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/categories").hasAnyRole("SUPER_ADMIN", "PRINCIPAL", "TEACHER")
                        .requestMatchers("/api/categories", "/api/categories/**").hasRole("SUPER_ADMIN")
